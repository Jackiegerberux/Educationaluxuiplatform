...
import { X, Clock, BookOpen, Lightbulb, ListChecks, ArrowRight, ExternalLink } from 'lucide-react';
            ...
            {!topic.content ? (
              ...
              <>
                <div className="flex items-center justify-between p-6 border-b border-zinc-800 shrink-0">
                  <h2 className="text-xl font-bold text-white">{t(topic.title)}</h2>
                  <button
                    onClick={onClose}
                ...
                <div className="flex-1 flex items-center justify-center p-6">
                  <div className="text-center">
                    <p className="text-zinc-400 mb-6">{t({ en: 'Preview not available', es: 'Vista previa no disponible' })}</p>
                    <Button onClick={handleOpenFullLesson} className="bg-indigo-600 hover:bg-indigo-700">
