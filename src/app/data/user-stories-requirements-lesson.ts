      ...
      steps: [
        {
          ...
          description: { en: 'Stakeholder says: "We need bulk assign for data packs in the admin tool. Users are complaining." Do not start designing yet. Ask: (1) Who is the user? (Answer: Telecom admins managing thousands of customers), (2) What is the goal? (Answer: Assign data packs to multiple customers at once instead of one-by-one), (3) What is the benefit? (Answer: Save 10+ hours/week of manual work). Now you have context to write a story.', es: 'Stakeholder dice: "Necesitamos asignación masiva para paquetes de datos en la herramienta admin. Usuarios se están quejando." No empieces a diseñar aún. Pregunta: (1) ¿Quién es el usuario? (Respuesta: Admins de telecom manejando miles de clientes), (2) ¿Cuál es el objetivo? (Respuesta: Asignar paquetes de datos a múltiples clientes a la vez en lugar de uno por uno), (3) ¿Cuál es el beneficio? (Respuesta: Ahorrar 10+ horas/semana de trabajo manual). Ahora tienes contexto para escribir una historia.' }
        },
        {
          name: { en: 'Step 2: Write the User Story', es: 'Paso 2: Escribe la User Story' },
          description: { en: 'Format: "As a [user type], I want [goal] so that [benefit]." Example: "As a telecom admin, I want to assign data packs to multiple customers at once so that I can save time and reduce manual errors." This is your story title. Add it to Jira/Linear. Do not write implementation details here ("use a modal", "add a checkbox"). Those come later. Keep the story focused on user value.', es: 'Formato: "Como [tipo de usuario], quiero [objetivo] para que [beneficio]." Ejemplo: "Como admin de telecom, quiero asignar paquetes de datos a múltiples clientes a la vez para ahorrar tiempo y reducir errores manuales." Este es tu título de historia. Agrégalo a Jira/Linear. No escribas detalles de implementación aquí ("usar modal", "agregar checkbox"). Esos vienen después. Mantén la historia enfocada en valor del usuario.' }
        },
        {
    ...
    aiInPractice: {
      ...
      prompts: [
        ...
        },
        {
          ...
          prompt: {
            en: 'User story: "As a telecom admin, I want to assign data packs to multiple customers at once so that I can save time and reduce manual errors." Generate 5-7 acceptance criteria using Given/When/Then format. Include: (1) Happy path, (2) Edge cases (e.g., 0 customers selected, API failure), (3) Non-functional requirements (e.g., performance, accessibility).',
            es: 'User story: "Como admin de telecom, quiero asignar paquetes de datos a múltiples clientes a la vez para ahorrar tiempo y reducir errores manuales." Genera 5-7 criterios de aceptación usando formato Given/When/Then. Incluye: (1) Happy path, (2) Casos límite (ej: 0 clientes seleccionados, falla de API), (3) Requisitos no funcionales (ej: rendimiento, accesibilidad).'
          }
        },
        {
          tool: 'ChatGPT',
    ...
    quiz: [
      {
        ...
        options: {
          en: [
            ...
            '"As a telecom admin, I want to assign data packs to multiple customers at once so that I can save time."',
          ...
          es: [
            ...
            '"Como admin de telecom, quiero asignar paquetes de datos a múltiples clientes a la vez para ahorrar tiempo."',
